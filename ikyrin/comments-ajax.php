			...
			if ( get_option('comment_registration') ||'private'== $status->post_status )
				...
				if ( get_option('require_name_email') &&!$user->ID ) {
					...
					if ( $comment_author_email ) $dupe .= "OR comment_author_email = '$comment_author_email' ";
						...
						<li class="hreview clearfix <?php if($comment->comment_author_email == get_the_author_email()) {echo 'admincomment<?php }else {echo 'evencomment<?php } ?>" id="comment-<?php comment_ID() ?>">
