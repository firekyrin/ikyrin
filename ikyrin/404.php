...
<div id="container">
	<div id="talker">
		<a href="<?php bloginfo('url');?>/" rel="nofollow"><img src="<?php bloginfo('template_url');?>/img/lovelace.gif" alt="<?php _e('Talker','ikyrin'); ?>" /></a>
	</div>
	<div id="notice">
		<h1><?php _e('Welcome to 404 error page!','ikyrin');?></h1>
		<p><?php _e("Welcome to this customized error page. You've reached this page because you've clicked on a link that does not exist. This is probably our fault... but instead of showing you the basic '404 Error' page that is confusing and doesn't really explain anything, we've created this page to explain what went wrong.",'ikyrin'); ?></p>
		<p><?php _e("You can either (a) click on the 'back' button in your browser and try to navigate through our site in a different direction, or (b) click on the following link to go to homepage.",'ikyrin'); ?></p>
		<div class="back">
			<a href="<?php bloginfo('url');?>/"><?php _e('Back to homepage &raquo;','ikyrin'); ?></a>
		</div>
	</div>
</div>
